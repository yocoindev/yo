...
uint256 hashGenesisBlock("0x97c6eefec4705930139193d5b409fa204ddfae2f21bd24c987d089c4a188c880");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1465382408, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04824b2df147618838fe05fa95dd14358589bbfd28faf75835248fa3b84abdf1c00d3ef957038d1d4d4df09ae29df58329d291cee953f2225f67913c8207cc4b88") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1465382408;
        ...
        assert(block.hashMerkleRoot == uint256("0x30764d9f0a744759ee3cde3af484022559a439adf9b189a614b4635eabe935a9"));
...
unsigned char pchMessageStart[4] = { 0x80, 0xd7, 0xc1, 0x02 }; // YoCoin: increase each by adding 2 to bitcoin's value.
